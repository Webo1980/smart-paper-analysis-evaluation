...
const ContentEvaluationReport = ({
  ...
  userInfo,
  onEditAssessment,
  evaluationComparison // Add this prop to receive comparison data
}) => {
  ...
  const overallScore = (accuracyScore * CONTENT_CONFIG.overallWeights.accuracy) + 
                      (qualityScore * CONTENT_CONFIG.overallWeights.quality);
  
  const scoreThresholds = CONTENT_CONFIG.scoreThresholds;
  ...
  const referenceType = orkgData?.template ? "ORKG template" : "content context";

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Content Evaluation Report</h2>
        <Button
          variant="outline"
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="text-2xl font-bold">
              {userInfo?.expertiseMultiplier}/5
            </div>
          </div>
      ...
      <Card className="p-4">
        <ContentAnalysis 
          ...
          evaluationComparison={evaluationComparison} // Pass the evaluation comparison data
        />
      </Card>
      <Card className="p-4">
        ...
        <Textarea
          ...
          placeholder="Add your expert observations about the content analysis..."
...
export default ContentEvaluationReport;